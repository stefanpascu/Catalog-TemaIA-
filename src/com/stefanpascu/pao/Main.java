...
public class Main {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        ClassbookService classbook = new ClassbookService(classbookName, teacher1, subjectName1, map1);
        while(true) {
            ...
            switch (caz) {
                case 1:
                    ...
                    for (Subject i : subjects) {
                        if (i.getName() == StringToSubjectName(subjectName) && i.getTeacher() == teacher2) {
                            subject1 = i;
                            break;
                        }
                    }
                ...
                case 5:
                    ...
                    for (Subject i : subjects5) {
                        if (i.getName() == StringToSubjectName(subjectName5) && i.getTeacher() == teacher5) {
                            subject5 = i;
                            break;
                        }
                    }
                ...
                case 6:
                    ...
                    for (Subject i : subjects6) {
                        if (i.getName() == StringToSubjectName(subjectName6) && i.getTeacher() == teacher6) {
                            subject6 = i;
                            break;
                        }
                    }
                ...
                case 9:
                    ...
                    for (Subject i : subjects9) {
                        if (i.getName() == StringToSubjectName(subjectName9) && i.getTeacher() == teacher9) {
                            subject9 = i;
                            break;
                        }
                    }
                ...
                case 12:
                    ...
                    for (Subject i : subjects12) {
                        if (i.getName() == StringToSubjectName(subjectName12) && i.getTeacher() == teacher12) {
                            subject12 = i;
                            break;
                        }
                    }
